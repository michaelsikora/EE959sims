...
mjs_platnum = 4; % number of platforms
...
if show_plots == 1
    ...
    if bb == 1 && saveplot == 1
        saveas(h2,sprintf('images/BOXplatformallseries_%d%d.png',bb,aa));
    end
end
...
%         axisnum = find(xyzbasis(vv,:) == 1);
    ...
    if bb == 1 && saveplot == 1
        saveas(h3,sprintf('images/BOXplatform1series_%d%d.png',bb,aa));
    end
end    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
