...
function err = sikora_platformSRPtestEars(indVarName,source,sampN,show_plots,saveplot)
...
mjs_platnum = 2; % number of platforms
...
mjs_pcs = [ dist2center(bb) 0.3 1.5;...
            dist2center(bb) -0.3 1.5 ];
...
if show_plots == 1
    ...
    if bb == 1 && saveplot == 1
        saveas(h2,sprintf('images/platformallseries_%d%d.png',bb,aa));
    end
end
...
%         axisnum = find(xyzbasis(vv,:) == 1);
    ...
    if bb == 1 && saveplot == 1
        saveas(h3,sprintf('images/platform1series_%d%d.png',bb,aa));
    end
end    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
